...
def countdown_timer():
    ...
    """, unsafe_allow_html=True)
def photo_gallery():
    st.markdown("<h2 style='text-align: center;'>📸 Memory Lane 📸</h2>", unsafe_allow_html=True)
    cols = st.columns(5)
    images = ["images/p1.png", "images/p2.png", "images/p3.png","images/p4.png","images/p5.png"]  # Add your image paths
    
    for idx, col in enumerate(cols):
        with col:
            if idx < len(images):
                st.image(images[idx], use_container_width=True)
                if st.button(f"❤️ Like Photo {idx+1}"):
                    st.balloons()

def virtual_gift():
        st.markdown("<h2 style='text-align: center;'>🎁 Open Your Virtual Gift</h2>", unsafe_allow_html=True)
...
>>>>>>> 7b60d64218d1d2a9cb04e662cf442222382aa0aa
    ...
    for memory in memories:
        ...
        """, unsafe_allow_html=True)
        if memory['title'] == "First Day in Class":
            st.image("images/tc.png", caption="First Day in Class", use_container_width=True)
        elif memory['title'] == "Study Sessions":
            st.image("images/sd.png", caption="Study Sessions", use_container_width=True)
        elif memory['title'] == "Biology Classes":
            st.image("images/bc.png", caption="Biology Classes", use_container_width=True)
